...
import { XvancoaAmbulanceWlEditor } from '../xvancoa-ambulance-wl-editor';
...
describe('xvancoa-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [XvancoaAmbulanceWlEditor],
      html: `<xvancoa-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></xvancoa-ambulance-wl-editor>`,
    });
